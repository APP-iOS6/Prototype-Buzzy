...
public struct BoardPost: Identifiable, Codable {
    ...
    public var imageName: String  // 새로 추가된 프로퍼티
    
    public init(id: UUID = UUID(), title: String, content: String, comments: [BoardComment] = [], likes: Int = 0, isScrapped: Bool = false, imageName: String = "defaultImage") {
        self.id = id
        self.title = title
        self.content = content
